<template>
    <div class="container-fluid py-5" style="background-color: #f5f5f5;">
      <div style="background-color: #ffffff; width: 400px min-height: 100vh;" class="p-5 m-auto login-form">
        ...
        <div class="my-4"><base-input type="text" identity="email" placeholder="Your E-Mail Address" v-model="loginData.email" label="Email"></base-input></div>
        <div class="my-4"><base-input type="password" identity="password" placeholder="Your Password" v-model="loginData.password" label="Password"></base-input></div>
        <base-button class="btn rounded-pill login w-100 my-3">Register</base-button>
      </form>
