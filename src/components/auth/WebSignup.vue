  ...
  <div class="container-fluid py-5" style="background-color: #f5f5f5">
    <div style="background-color: #ffffff" class="p-5 m-auto signup-form">
      <div class="text-center">
        ...
        <p>Enter your details so you can use this app to the fullest!</p>
      </div>
      <form class="mt-3" @submit.prevent="register">
        <div class="row">
          <div class="col-md-6"><base-input type="text" identity="firstname" placeholder="Ex: Jack" label="First Name"></base-input></div>
          <div class="col-md-6"><base-input type="text" identity="lastname" placeholder="Ex: Daniel" label="Last Name"></base-input></div>
        </div>
        <div class="my-4"><base-input type="text" identity="username" placeholder="Your Username" label="Username"></base-input></div>
        <div class="my-4"><base-input type="text" identity="email" placeholder="Your E-Mail Address" v-model="signupData.email" label="Email"></base-input></div>
        <div class="my-4">
        ...
        <div class="my-4">
          <base-input type="password" identity="confirmationPassword" placeholder="Same with password" label="Confirmation Password" v-model="signupData.confirmationPassword" @keyInput="confirmationPasswordCheck">
          </base-input>
        ...
        <div class="my-4">
          ...
          label="Profile Picture" accept="image/*" isImage="true" @input="checkImage">
            <div>
        ...
        <base-button class="btn rounded-pill login w-100 my-3">Register
        </base-button>
      </form>
      <div class="text-center mt-4">
        <p class="fw-semibold">Already have account? 
