<template>
    ...
    <p style="font-size: 15px">
        Find the most everyday cooking inspiration on Integrated Recipes. Discover authentic recipes easily integrated into your life, all based on things that you love.
    </p>
    </div>
